// SUMMARY: this file handles all of the functionality on the various Reporting pages of Budget Tracker.
    ...
    let spendingChart = new Chart(chartElement, {
      ...
      options: {
        ...
        title: {
          display: true,
          text:
            "Total spent, total # of expenses, and % of overall spent per spend category",
        },
        scales: {
          yAxes: [
            {
